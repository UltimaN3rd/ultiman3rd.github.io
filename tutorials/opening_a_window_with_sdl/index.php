...
<code><xmp>sudo apt install libsdl2-dev</xmp></code>
...
<code><xmp>#include <SDL2/SDL.h>

int main(int argc, char* argv[]){
    SDL_Init(0);
    
    SDL_Window* window = SDL_CreateWindow("Nick's SDL2 window", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 1280, 720, SDL_WINDOW_RESIZABLE);
...
<code><xmp>    // After creating the window, before the infinite loop
    SDL_Surface* canvas = SDL_GetWindowSurface(window);</xmp></code>
...
#include <stdint.h>
        ...
        // End of main loop before SDL_UpdateWindowSurface
        *((uint32_t*)(canvas->pixels) + 128*1280+64) = 0xffffffff;</xmp></code>
...
<code><xmp>    // Before main loop
    int x = 0, y = 0;
                    ...
                    // Inside SDL_KEYDOWN switch(e.key.keysym.sym)
                        case SDLK_UP:{
                            if(--y < 0){
                                y = 0;
                            }
        ...
        // End of main loop
        *((uint32_t*)(canvas->pixels) + y*window_width+x) = 0xffff0000;</xmp></code>
...
<code><xmp>                // After case: SDL_KEYDOWN
                    if(!e.key.repeat){
                        switch(e.key.keysym.sym){
                            case SDLK_ESCAPE:{
                                game_running = false;
...
#include <cstring>
        ...
        // Start of main loop
        memset(canvas->pixels, 0, window_width*window_height*4);</xmp></code>
...
#include <cstdio>
    ...
    frame_start = SDL_GetPerformanceCounter();
        ...
        SDL_SetWindowTitle(window, title);</xmp></code>
